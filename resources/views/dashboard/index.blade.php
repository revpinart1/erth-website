...
<main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          ...
          <ul class="navbar-nav d-flex align-items-center ">
            ...
            <li class="nav-item d-flex align-items-center justify-content-center">
              ...
              <h1><strong dir="rtl">{{ auth()->user()->name }}مرحبا بك يا</strong></h1>
              </a>
            </li>
          </ul>
        </div>
    ...
    <div class="container-fluid py-2">
      <div class="row">
        <div class="ms-3">
        <h1><strong>لوحة التحكم</strong></h1>
        <hr>
          <p class="mb-4">
        ...
        <div class="col-xl-4 col-sm-6 mb-xl-0 mb-4">
          <div class="card">
            <div class="card-header p-2 ps-3">
              ...
              <div>
                     <p class="text-sm mb-0 text-capitalize">عدد المتاحف</p>
                     <h4 class="mb-0">{{$Museumscount}}</h4>
                    </div>
        ...
        <div class="col-xl-4 col-sm-6 mb-xl-0 mb-4">
          <div class="card">
            <div class="card-header p-2 ps-3">
              <div class="d-flex justify-content-between">
                <div>
                  <p class="text-sm mb-0 text-capitalize">عدد الحجوزات اليوم</p>
      ...
      <!-- <div class="row">
        ...
        <div class="col-lg-4 col-md-6 mt-4 mb-4">
          <div class="card ">
            <div class="card-body">
              <h6 class="mb-0 "> عدد الحجوزات اليومية</h6>
        ...
        <div class="col-lg-4 mt-4 mb-3">
          <div class="card">
            <div class="card-body">
              <h6 class="mb-0 ">المهمات المنجزة</h6>
          ...
          <div class="card h-100">
            <div class="card-header pb-0">
              ...
              <p class="text-sm">
                ...
                <span class="font-weight-bold"></span> هذا الشهر
              </p>
            </div>
